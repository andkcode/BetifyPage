<template>
      ...
      <div class="flex flex-col items-start justify-start w-full pl-10 pt-10 space-y-2">
        <h1 class="text-[1rem] font-bold text-blue-400">Get Started</h1>
        <p class="text-black text-5xl font-semibold">How to deposit</p>
      </div>
